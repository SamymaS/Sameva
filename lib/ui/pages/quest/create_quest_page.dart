...
class _CreateQuestPageState extends State<CreateQuestPage> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (context.watch<CreateQuestViewModel>().errorMessage != null) ...[
                    const SizedBox(height: 16),
                    Text(
                      context.watch<CreateQuestViewModel>().errorMessage!,
                      style: TextStyle(color: AppColors.error, fontSize: 14),
                    ),
                  ],
                  const SizedBox(height: 32),
                  Consumer<CreateQuestViewModel>(
  ...
  Future<void> _submit() async {
    ...
    final vm = context.read<CreateQuestViewModel>();
