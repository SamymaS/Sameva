...
class ItemFactory {
  ...
  static final List<Map<String, dynamic>> _catalog = [
    ...
    // Chapeaux supplémentaires
    {
      ...
      'rarity': QuestRarity.uncommon,
      'iconCodePoint': Icons.auto_awesome.codePoint,
      'stats': {'colorValue': 0xFF4299E1, 'styleIndex': 1},
      'goldValue': 120,
      'cosmeticSlot': 'hat',
    },
    {
      ...
      'rarity': QuestRarity.epic,
      'iconCodePoint': Icons.workspace_premium.codePoint,
      'stats': {'colorValue': 0xFF76E4F7, 'styleIndex': 2},
      'goldValue': 400,
      'cosmeticSlot': 'hat',
    },
    {
      ...
      'stats': {'colorValue': 0xFFE53E3E, 'styleIndex': 3},
      'goldValue': 80,
      'cosmeticSlot': 'hat',
    },
    {
      ...
      'stats': {'colorValue': 0xFF553C9A, 'styleIndex': 3},
      'goldValue': 380,
      'cosmeticSlot': 'hat',
    },
    {
      ...
      'stats': {'colorValue': 0xFF4FD1C5, 'styleIndex': 4},
      'goldValue': 60,
      'cosmeticSlot': 'hat',
    },
    {
      ...
      'stats': {'colorValue': 0xFFED8936, 'styleIndex': 4},
      'goldValue': 220,
      'cosmeticSlot': 'hat',
    },
    ...
    // --- CHAUSSURES ---
    {
      ...
      'description': 'Des bottes sombres solides pour toutes les terrains.',
      'type': ItemType.cosmetic,
      'rarity': QuestRarity.common,
      'iconCodePoint': Icons.hiking.codePoint,
      'stats': {'colorValue': 0xFF3D2B1A},
      'goldValue': 55,
      'cosmeticSlot': 'shoes',
    },
    {
    ...
    },
    {
      ...
      'iconCodePoint': Icons.bolt.codePoint,
      'stats': {'colorValue': 0xFFFC8181},
      'goldValue': 900,
      'cosmeticSlot': 'shoes',
    },
    // Auras supplémentaires
    {
      'name': 'Aura de Feu',
